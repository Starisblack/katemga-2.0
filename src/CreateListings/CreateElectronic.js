...
<form action="/electronicsCompose" method="post" enctype="multipart/form-data">
  <div id="form-group">
    <label for="title">Posting Title</label>
    <input className="form-control" type="text" name="electronicTitle" required />
    ...
    <input className="form-control" type="text" name="electronicLocation" />
  ...
  <button className="btn btn-primary post-btn" type="submit">Post listing</button>
</form>
</div>
    )
}
